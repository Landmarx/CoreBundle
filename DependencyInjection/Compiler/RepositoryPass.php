<?php
namespace Landmarx\Bundle\CoreBundle\DependencyInjection\Compiler;
...
class RepositoryPass implements CompilerPassInterface
{
    ...
    {
        $factory = $container->findDefinition('landmarx.repository.factory');
 
        $repositories = [];
        foreach ($container->findTaggedServiceIds('landmarx.repository') as $id => $params) {
